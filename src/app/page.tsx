                ...
                <>
                  ...
                  {chartDays.length > 0 ? (
                    <div style={{background:'#FFFFFF',border:'1px solid #E2E2DC',borderRadius:12,padding:16}}>
                      ...
                      {/* Bars row — alignItems:flex-end makes bars grow upward from baseline */}
                      <div style={{display:'flex',alignItems:'flex-end',gap:6,height:100,marginBottom:6,overflow:'hidden'}}>
                        {chartDays.map(bar => (
                          <div key={bar.label+'-bar'} style={{
                            flex:1,
                            height:`${bar.h}px`,
                            ...
                            <span style={{
                              fontSize:9,
                              fontWeight:700,
                              color:bar.today?'rgba(255,255,255,0.9)':'rgba(81,112,255,0.8)',
                      ...
                      <div style={{display:'flex',gap:6}}>
                        {chartDays.map(bar => (
                          <div key={bar.label+'-lbl'} style={{flex:1,textAlign:'center',fontSize:9,color:'#ADADAD',whiteSpace:'nowrap'}}>{bar.label}</div>
                        ))}
                      </div>
                    </div>
                  ) : (
